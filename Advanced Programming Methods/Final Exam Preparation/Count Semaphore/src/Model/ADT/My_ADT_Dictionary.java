...
public class My_ADT_Dictionary<T1, T2> implements My_I_Dict<T1, T2> {
    ...
    @Override
    public My_I_Dict<T1, T2> deepCopy() throws ADT_Exception {
        My_I_Dict<T1, T2> toReturn = new My_ADT_Dictionary<>();
        for (T1 key: keySet())
