...
public class Heap_Allocation_Statement implements IStatement{
    ...
    public My_I_Dict<String, IType> typeCheck(My_I_Dict<String, IType> typeEnv) throws Statement_Execution_Exception, Expression_Evaluation_Exception, ADT_Exception {
        ...
        if (typeVar.equals(new Ref_Type(typeExpr)))
            return typeEnv;
        else
            throw new Statement_Execution_Exception("ERROR: NEW statement: right hand side and left hand side have different types.");
    }
