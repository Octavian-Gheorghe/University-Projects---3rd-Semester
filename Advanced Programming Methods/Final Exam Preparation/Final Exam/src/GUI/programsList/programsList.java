    ...
    public void displayProgram(MouseEvent actionEvent) {
        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                PrgState prg = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(), new MyList<Value>(), new MyFileTable<String, BufferedReader>(), new MyHeap<Integer, Value>(), selectedStatement);
