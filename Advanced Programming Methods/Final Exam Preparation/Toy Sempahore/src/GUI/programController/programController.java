...
public class programController {
    ...
    @FXML
    private TableView<Tuple> toySemaphoreTableView;

    @FXML
    private TableColumn<Tuple, Integer> indexToyColumn;

    @FXML
    private TableColumn<Tuple, Integer> valueToyColumn;

    @FXML
    private TableColumn<Tuple, List<Integer>> listToyColumn;
    ...
    private void initialize() {
        ...
        indexToyColumn.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().getFirst()).asObject());
        listToyColumn.setCellValueFactory(p -> new SimpleObjectProperty<>(p.getValue().getSecond()));
       // listBarrierColumn.setCellValueFactory(p -> new SimpleStringProperty(p.getValue().getValue().getValue().toString()));

        valueToyColumn.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().getThird()).asObject());
    }
