...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIList<Value> ot,MyIFileTable<String,BufferedReader> fileTable, MyIHeap<Integer, Value> heap, MyIToySemaphoreTable toySemaphoreTable,  IStmt prg){
        this.exeStack = stk;
    ...
    public MyIToySemaphoreTable getToySemaphoreTable(){return this.toySemaphoreTable;}
