...
public class Program_State {
    ...
    private My_I_Dict<String, IValue> symTable;
    ...
    public Program_State(My_I_Stack<IStatement> stack, My_I_Dict<String, IValue> symTbl, My_I_List<IValue> _out, IStatement program, My_I_Dict<String, BufferedReader> fileTbl, My_I_Heap heap){
        exeStack = stack;
        symTable = symTbl;
        out = _out;
    ...
    public Program_State(My_I_Stack<IStatement> stack, My_I_Dict<String, IValue> symTbl, My_I_List<IValue> _out, My_I_Dict<String, BufferedReader> fileTbl, My_I_Heap heap){
        exeStack = stack;
        symTable = symTbl;
        out = _out;
        fileTable = fileTbl;
    ...
    public void setSymTable(My_I_Dict<String, IValue> newSymTable) {
    ...
    public My_I_Dict<String, IValue> getSymTable(){
        return symTable;
    }
