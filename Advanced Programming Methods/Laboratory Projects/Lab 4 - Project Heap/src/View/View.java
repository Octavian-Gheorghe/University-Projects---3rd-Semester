...
public class View {
    ...
    private void runPrg1() throws Statement_Execution_Exception, ADT_Exception, Expression_Evaluation_Exception, Division_By_Zero_Exception, IOException {
        I_Statement stmt = new Compound_Statement(new Variable_Declaration_Statement("v", new Int_Type()),
    ...
    private void runPrg2() throws Statement_Execution_Exception, ADT_Exception, Expression_Evaluation_Exception, Division_By_Zero_Exception, IOException {
        I_Statement stmt = new Compound_Statement(new Variable_Declaration_Statement("a",new Int_Type()),
    ...
    private void runPrg3() throws Statement_Execution_Exception, ADT_Exception, Expression_Evaluation_Exception, Division_By_Zero_Exception, IOException {
        I_Statement stmt = new Compound_Statement(new Variable_Declaration_Statement("a", new Bool_Type()),
    ...
    private void runStatement(I_Statement stmt) throws Expression_Evaluation_Exception, Statement_Execution_Exception, ADT_Exception, Division_By_Zero_Exception, IOException {
        My_I_Stack<I_Statement> executionStack = new My_ADT_Stack<>();
        My_I_Dict<String, I_Value> symbolTable = new My_ADT_Dict<>();
        My_I_List<I_Value> out = new My_ADT_List<>();
        My_I_Dict<String, BufferedReader> fileTable = new My_ADT_Dict<>();
